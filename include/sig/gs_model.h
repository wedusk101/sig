...
{ public :
  ...
  public : // construction functions:
	...
	/*! Check and remove redundant vertices and then remove collapsed faces.
		...
		If remunused is given as true (the default) non-used vertices are removed.
	...
	void remove_redundant_vertices ( float prec=gstiny, bool remunused=true, bool comp=true );

	/*! Specific method only to remove unused vertices. */
	void remove_unused_vertices ( bool comp=true );
